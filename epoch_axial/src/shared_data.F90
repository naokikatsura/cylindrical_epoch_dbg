...
MODULE shared_data
 ...
 ! Object representing a particle species
  ...
  INTEGER :: subtype_mode, subtype_mode_r4
  INTEGER :: subarray_mode, subarray_mode_r4 
  INTEGER :: subarray_mode_big, subarray_mode_big_r4
  ...
  COMPLEX(num), ALLOCATABLE, DIMENSION(:,:,:) :: exm, erm, etm
  COMPLEX(num), ALLOCATABLE, DIMENSION(:,:,:) :: bxm, brm, btm

!==============================================================================
! 2024/08/01 by katsura
!------------------------------------------------------------------------------
!  COMPLEX(num), ALLOCATABLE, DIMENSION(:,:,:) :: bxm_initial, brm_initial, &
!                                                 btm_initial
!==============================================================================

  COMPLEX(num), ALLOCATABLE, DIMENSION(:,:,:) :: jxm, jrm, jtm
  ...
  COMPLEX(num), ALLOCATABLE, DIMENSION(:,:) :: exm_x_min, exm_x_max
  COMPLEX(num), ALLOCATABLE, DIMENSION(:,:) :: erm_x_min, erm_x_max
  COMPLEX(num), ALLOCATABLE, DIMENSION(:,:) :: etm_x_min, etm_x_max
  COMPLEX(num), ALLOCATABLE, DIMENSION(:,:) :: bxm_x_min, bxm_x_max
  COMPLEX(num), ALLOCATABLE, DIMENSION(:,:) :: brm_x_min, brm_x_max
  COMPLEX(num), ALLOCATABLE, DIMENSION(:,:) :: btm_x_min, btm_x_max
